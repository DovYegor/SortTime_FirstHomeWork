...
void durSortToFile(int time1, int time2, int time3, int time4, int time5, int time6, int time7, int _size) {
     FILE *sort1 = fopen ("C:\\МГТУ\\2 семестр\\Основы программирования на C++\\ReleaseSortTime\\SortTime.txt", "a");
...
int main()
{
    FILE *sort = fopen ("C:\\МГТУ\\2 семестр\\Основы программирования на C++\\ReleaseSortTime\\SortTime.txt", "w");
    fclose(sort);
    int *my_array;
